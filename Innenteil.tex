...
\nocite{*}
	...
	\subsection{Datenmengen in unserer Welt}
		...
		Dadurch das immer mehr Daten gespeichert werden verdoppelt sich der Datenbestand alle zwei Jahre. 2020 lag er bei etwa 40 Zettabytes. Bis 2025 sollen es schätzungsweise 163 Zettabytes werden.%\cite{DataAge:Peinsel}
		\begin{quote}
...
\end{minted}
		...
		\ac{KVDB} sind sehr beliebte NoSQL-Datenbanken. Das liegt vorallem daran, dass sie sehr gut skalierbar sind. Zudem müssen keine Integritätsbedingungen überprüft werden, was eine höchst performante Datenspeicherung und Abfrage ermöglicht. \\
...
\subsection{JSON}
	...
	\begin{itemize}
		...
		\item Eckige Klammern werden verwendet um Array zu speichern.
	\end{itemize}
